package pe.com.datatech.asistencia.config;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import pe.com.datatech.asistencia.web.access.expression.CustomWebSecurityExpressionHandler;
import pe.com.datatech.asistencia.web.access.intercept.FilterInvocationServiceSecurityMetadataSource;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		// Logout
		http.logout().logoutUrl("/logout").logoutSuccessUrl("/login?logout").deleteCookies("JSESSIONID")
	...
	public void configure(final WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers("/js/**").antMatchers("/img/**").antMatchers("/css/**").antMatchers("/fonts/**");
